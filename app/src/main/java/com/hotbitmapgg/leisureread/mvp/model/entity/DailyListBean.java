...
public class DailyListBean implements Parcelable {
  ...
  private List<DailyInfo> stories;
  ...
  public List<DailyInfo> getStories() {

    return stories;
  }


  public void setStories(List<DailyInfo> stories) {
  ...
  protected DailyListBean(Parcel in) {
    ...
    this.stories = in.createTypedArrayList(DailyInfo.CREATOR);
