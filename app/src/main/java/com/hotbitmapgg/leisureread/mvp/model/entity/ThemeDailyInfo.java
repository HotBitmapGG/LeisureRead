 ...
 * @HotBitmapGG 主题日报模型类
 */
public class ThemeDailyInfo implements Parcelable {
  /**
   * limit : 1000
   * subscribed : []
  ...
  public void setSubscribed(List<String> subscribed) { this.subscribed = subscribed;}


  public List<OthersBean> getOthers() { return others;}


  public void setOthers(List<OthersBean> others) { this.others = others;}


  public static class OthersBean implements Parcelable {
    /**
     * color : 15007
    ...
    protected OthersBean(Parcel in) {
    ...
    public static final Creator<OthersBean> CREATOR = new Creator<OthersBean>() {
      @Override public OthersBean createFromParcel(Parcel source) {return new OthersBean(source);}


      @Override public OthersBean[] newArray(int size) {return new OthersBean[size];}
    };
  }
  ...
  @Override public void writeToParcel(Parcel dest, int flags) {
    ...
    dest.writeStringList(this.subscribed);
    dest.writeList(this.others);
  }


  public ThemeDailyInfo() {}


  protected ThemeDailyInfo(Parcel in) {
    this.limit = in.readInt();
    this.subscribed = in.createStringArrayList();
    this.others = new ArrayList<OthersBean>();
    in.readList(this.others, OthersBean.class.getClassLoader());
  }


  public static final Parcelable.Creator<ThemeDailyInfo> CREATOR
      = new Parcelable.Creator<ThemeDailyInfo>() {
    @Override public ThemeDailyInfo createFromParcel(Parcel source) {
      return new ThemeDailyInfo(source);
    }


    @Override public ThemeDailyInfo[] newArray(int size) {return new ThemeDailyInfo[size];}
  };
}
