...
import com.hotbitmapgg.eyepetizer.model.component.DaggerSectionsComponent;
import com.hotbitmapgg.eyepetizer.presenter.SectionsPresenter;
import com.hotbitmapgg.eyepetizer.presenter.sections.SectionsPresenterMoudle;
import com.hotbitmapgg.eyepetizer.view.fragments.DailyListFragment;
import com.hotbitmapgg.eyepetizer.view.fragments.SectionsFragment;
import com.hotbitmapgg.eyepetizer.view.fragments.ThemesDailyFragment;
import com.hotbitmapgg.eyepetizer.view.fragments.UserInfoFragment;
...
public class MainActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DaggerSectionsComponent.builder()
                ...
                .appComponent(EyepetizerDailyApp.getAppContext().getAppComponent())
                .build()
                .inject(this);
