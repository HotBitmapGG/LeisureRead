...
import com.hotbitmapgg.eyepetizer.mvp.model.entity.DailyBean;
import com.hotbitmapgg.eyepetizer.mvp.model.entity.DailyListBean;
import com.hotbitmapgg.eyepetizer.mvp.model.entity.TopDailys;
import com.hotbitmapgg.eyepetizer.network.RetrofitHelper;
import com.hotbitmapgg.eyepetizer.ui.adapter.DailyListAdapter;
...
public class DailyListFragment extends BaseFragment {
  ...
  public DailyListBean changeReadState(DailyListBean dailyList) {
    ...
    for (DailyBean daily : dailyList.getStories()) {
      ...
      allReadId.stream()
          .filter(readId -> readId.equals(String.valueOf(daily.getId())))
          .forEach(readId -> daily.setRead(true));
    }
    return dailyList;
  }
}
